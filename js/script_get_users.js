$( function() {
	...
	$( '.edit_email' ).focus( function() {
		...
		if ( newVal.length > 2 ) {
			...
			window.location.reload();
			alert( 'Email должен быть не менее 2 символов! Повторите попытку!' );
		}
	});
	...
	$( '.edit_company' ).focus( function() {
		...
		if ( newVal.length > 2 && newVal.length < 20 ) {
			...
			alert( 'Company должен быть не менее 3 символов и не больше 20 ! Повторите попытку!' );
			window.location.reload();
			console.log( 'Login должен быть не менее 4 символов! Повторите попытку!' );
		}
	});
	...
	$( '.edit_company_email' ).focus( function() {
		...
		if ( newVal.length > 2 ) {
			...
			window.location.reload();
			alert( 'Email должен быть не менее 3 символов! Повторите попытку!' );
		}
	});
