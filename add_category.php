<?php  
	...
	include "includes/admin_add_category.php";
?>
...
<body>
	...
	<div class="container mt-2">
		...
		<form action="" id="emailForm" method="POST">
			<div class="form-group">
				<input class="form-control" id="category" placeholder="Введите категорию"  
					type="text" name="category" value="<?php echo @$data['category']; ?>">
			</div>
			<div class="form-group">
				<button type="submit" id="button" name="b_category" class="btn btn-primary">Добавить</button>	
				<a class="btn btn-warning" href="category.php">Редактировать категорию</a>
			</div>
			<div class="form-group">
